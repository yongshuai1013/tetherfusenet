...
internal fun SocketTimeout(
  ...
  Column(
    ...
    Text(
        ...
        text = stringResource(R.string.expert_socket_timeout_description, appName),
        style =
    ...
    Button(
        ...
        onClick = onShowSocketTimeout,
        enabled = isEditable,
    ) {
      Text(
          text = stringResource(R.string.expert_socket_timeout_button),
      )
    }
  }
}
